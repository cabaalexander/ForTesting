...
namespace SoapAPIClient.GeoIPService {
    ...
    public interface GeoIPServiceSoap {
        ...
        SoapAPIClient.GeoIPService.GeoIP GetGeoIP(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIP", ReplyAction="*")]
        System.Threading.Tasks.Task<SoapAPIClient.GeoIPService.GeoIP> GetGeoIPAsync(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        SoapAPIClient.GeoIPService.GeoIP GetGeoIPContext();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        System.Threading.Tasks.Task<SoapAPIClient.GeoIPService.GeoIP> GetGeoIPContextAsync();
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface GeoIPServiceSoapChannel : SoapAPIClient.GeoIPService.GeoIPServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GeoIPServiceSoapClient : System.ServiceModel.ClientBase<SoapAPIClient.GeoIPService.GeoIPServiceSoap>, SoapAPIClient.GeoIPService.GeoIPServiceSoap {
        ...
        public SoapAPIClient.GeoIPService.GeoIP GetGeoIP(string IPAddress) {
            return base.Channel.GetGeoIP(IPAddress);
        }
        
        public System.Threading.Tasks.Task<SoapAPIClient.GeoIPService.GeoIP> GetGeoIPAsync(string IPAddress) {
            return base.Channel.GetGeoIPAsync(IPAddress);
        }
        
        public SoapAPIClient.GeoIPService.GeoIP GetGeoIPContext() {
            return base.Channel.GetGeoIPContext();
        }
        
        public System.Threading.Tasks.Task<SoapAPIClient.GeoIPService.GeoIP> GetGeoIPContextAsync() {
